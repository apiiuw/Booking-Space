...
>
    ...
    <h3 class="text-orange-600 text-md mb-6">
        Pilihlah bukti peminjaman yang ingin dilihat
    </h3>
    ...
    >
        <div
            x-transition.scale
            class="bg-white rounded-2xl shadow-2xl w-full max-w-5xl mx-4"
        >
            ...
            <div class="flex items-center justify-between px-6 py-4 bg-orange-50 border-b">
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        Kode: <span class="font-semibold" x-text="kode"></span>
                    </p>
                </div>
            ...
            {{-- BODY (INI YANG SCROLL, BUKAN MODAL / IFRAME) --}}
            <div class="h-[75vh] overflow-y-auto bg-gray-100 p-4">
