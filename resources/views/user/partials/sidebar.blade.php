...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-30 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pt-24 overflow-y-auto bg-gray-50">
      <ul class="font-medium">
         ...
         <li class="mt-2">
            <a href="{{ route('bukti.peminjaman') }}"
               class="flex items-center p-2 rounded-lg group
                     {{ request()->routeIs('bukti.peminjaman') 
               ...
               <span class="ms-3">Bukti Peminjaman</span>
            </a>
         ...
         <li class="mt-2">
            <a href="{{ route('riwayat.peminjaman') }}"
               class="flex items-center p-2 rounded-lg group
                     {{ request()->routeIs('riwayat.peminjaman*') 
                           ? 'bg-orange-600 text-white' 
                           : 'text-gray-900 hover:bg-gray-100' }}">
